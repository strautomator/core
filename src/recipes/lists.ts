...
export const recipePropertyList = [
    ...
    {value: "segmentIncluded", text: "Has completed the specified segment at least once", type: "boolean", operators: recipeOperatorList.is},
    {value: "komSegments", text: "Has new segment KOMs", type: "string", operators: recipeOperatorList.is, suffix: "(Strava segment ID)"},
