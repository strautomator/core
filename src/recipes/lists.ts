...
export const recipePropertyList = [
    ...
    {value: "paceAvg", text: "Average pace", shortText: "Avg pace", type: "time", operators: recipeOperatorList.pace, suffix: "/km", impSuffix: "/mi", sportSuffix: {Swim: "/100m"}},
    {value: "paceMax", text: "Maximum pace", shortText: "Max pace", type: "time", operators: recipeOperatorList.pace, suffix: "/km", impSuffix: "/mi", sportSuffix: {Swim: "/100m"}},
    ...
    {value: "wattsWeighted", text: "Normalized power", shortText: "NP power", type: "number", operators: recipeOperatorList.number, min: 0, max: 9999, suffix: "watts"},
    {value: "wattsMax", text: "Maximum power", shortText: "Max power", type: "number", operators: recipeOperatorList.number, min: 0, max: 9999, suffix: "watts"},
    {value: "wattsKg", text: "Watts / kg", type: "number", operators: recipeOperatorList.number, min: 0, max: 99},
    {value: "hrAvg", text: "Average heart rate", shortText: "Avg HR", type: "number", operators: recipeOperatorList.number, min: 0, max: 999, suffix: "bpm"},
    {value: "hrMax", text: "Max heart rate", shortText: "Max HR", type: "number", operators: recipeOperatorList.number, min: 0, max: 999, suffix: "bpm"},
    {value: "hasCadence", text: "Has a cadence sensor", type: "boolean", operators: recipeOperatorList.is},
    {value: "cadenceAvg", text: "Average cadence", shortText: "Avg cadence", type: "number", operators: recipeOperatorList.number, min: 0, max: 999, suffix: "rpm", sportSuffix: {Run: "spm", Swim: "spm"}},
    ...
    {value: "segments", text: "Has the specified segment (ID)", type: "string", operators: recipeOperatorList.is},
    {value: "segments.kom", text: "Has new segment KOMs", type: "boolean", operators: recipeOperatorList.is},
    {value: "segments.pr", text: "Has new segment PRs", type: "boolean", operators: recipeOperatorList.is},
