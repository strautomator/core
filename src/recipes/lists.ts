...
export const recipePropertyList = [
    ...
    {value: "garmin.primaryBenefit", text: "Garmin primary benefit", type: "string", operators: recipeOperatorList.is},
    {value: "garmin.tss", text: "Garmin TSS", type: "number", operators: recipeOperatorList.number},
    {value: "garmin.trainingLoad", text: "Garmin training load", type: "number", operators: recipeOperatorList.number},
    {value: "garmin.intensityFactor", text: "Garmin intensity factor", type: "number", operators: recipeOperatorList.number},
    {value: "garmin.aerobicTrainingEffect", text: "Garmin aerobic training effect", type: "number", operators: recipeOperatorList.number, min: 0, max: 5},
    {value: "garmin.anaerobicTrainingEffect", text: "Garmin anaerobic training effect", type: "number", operators: recipeOperatorList.number, min: 0, max: 5},
    ...
    {value: "garmin.workoutName", text: "Garmin workout name", type: "string", operators: recipeOperatorList.text},
    {value: "garmin.workoutNotes", text: "Garmin workout notes", type: "string", operators: recipeOperatorList.text},
    {value: "wahoo.sensor", text: "Wahoo sensor ID", type: "string", operators: recipeOperatorList.is},
...
export const recipeActionList = [
    ...
    {value: "generateDescription", text: "Generate a poem with AI"},
