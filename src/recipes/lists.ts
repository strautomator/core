...
export const recipePropertyList = [
    ...
    {value: "paceAvg", text: "Average pace", type: "time", operators: recipeOperatorList.pace, suffix: "/km", impSuffix: "/mi"},
    {value: "paceMax", text: "Max pace", type: "time", operators: recipeOperatorList.pace, suffix: "/km", impSuffix: "/mi"},
