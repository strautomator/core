...
export const recipePropertyList = [
    ...
    {value: "wattsAvg", text: "Average power", shortText: "Avg power", type: "number", operators: recipeOperatorList.number, suffix: "watts", min: 0, max: 5000},
    {value: "wattsWeighted", text: "Normalized power", type: "number", operators: recipeOperatorList.number, suffix: "watts", min: 0, max: 5000},
    {value: "wattsMax", text: "Maximum power", shortText: "Max power", type: "number", operators: recipeOperatorList.number, suffix: "watts", min: 0, max: 5000},
