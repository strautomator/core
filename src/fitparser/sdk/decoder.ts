...
class Decoder {
    ...
    #decodeMode: any = DecodeMode.NORMAL
    ...
    static isFIT(stream) {
        try {
            ...
            const fileHeader: any = Decoder.#readFileHeader(stream, {resetPosition: true})
    ...
    checkIntegrity() {
        try {
            ...
            const fileHeader: any = Decoder.#readFileHeader(this.#stream, {resetPosition: true})
            ...
            if (fileHeader.headerSize === HEADER_WITH_CRC_SIZE && fileHeader.headerCRC !== 0x0000 && fileHeader.headerCRC != CrcCalculator.calculateCRC(buf, 0, 12)) {
                return false
            }
    ...
    #setAccumulatedField(messageDefinition, message, field, rawFieldValue) {
        ...
        rawFieldValues.forEach((value) => {
            Object.values(message).forEach((containingField: any) => {
