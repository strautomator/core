...
export const RideFast = [
    "Check that ${speedAvg} ride today by ${user}! Automated with Strautomator 🙂",
    "Impressively fast ride by ${user}! ${speedAvg} average speed 😲",
    "Rocket speed 🚀 Check that ${speedAvg} ride by ${user}.",
...
export const RunLongDistance = [
    "Check that ${distance} run today by ${user}! Automated with Strautomator 🙂",
    ...
    "Keep on running, ${user}! And well done for your ${distance} run today 🙂"
]
...
export const RunFast = [
    "Check that ${speedAvg} ride today by ${user}! Automated with Strautomator 🙂",
    "Impressively fast pace by ${user}! ${speedAvg} average speed, well done!",
    "Keep on running, ${user}! And well done for your ${speedAvg} run today 🙂"
]
